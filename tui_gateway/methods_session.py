...
def _(rid, params: dict) -> dict:
    ...
    # SillyTavern sends these once, with the seed transcript, so the agent's
    # identity and response contract stay byte-stable for the whole session.
    # Keeping this on session.create (rather than prompt.submit) preserves
    # Hermes' system-prompt cache invariant.
    sillytavern_context = {
